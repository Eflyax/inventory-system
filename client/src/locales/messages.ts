export const messages = {
  cs: {
		...
		'transactionAction.sell': 'odepsal{woman}',
		'transactionAction.buy': 'naskladnil{woman}',
		'transactionAction.move': 'přesunul{woman}',
		'transactionAction.remove': 'odstranil{woman}',
		'Nastavení': 'Nastavení',
		'Sklad': 'Sklad',
		'Přehled': 'Přehled',
